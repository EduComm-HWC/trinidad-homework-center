  ...
  const students = await Promise.all([
    ...
    prisma.student.create({
      data: {
        ...
        grade: 'Standard 4',
        subjects: JSON.stringify(['Mathematics', 'English', 'Science']),
        csecSubjects: JSON.stringify([]),
    ...
    prisma.student.create({
      data: {
        ...
        grade: 'Standard 5',
        subjects: JSON.stringify(['Mathematics', 'English', 'Science', 'Social Studies']),
        csecSubjects: JSON.stringify([]),
    ...
    prisma.student.create({
      data: {
        ...
        grade: 'Form 3',
        subjects: JSON.stringify(['Mathematics', 'English', 'Chemistry', 'Physics']),
        csecSubjects: JSON.stringify(['Mathematics', 'English Language', 'Chemistry', 'Physics', 'Biology', 'Spanish']),
    ...
    prisma.student.create({
      data: {
        ...
        grade: 'Form 4',
        subjects: JSON.stringify(['Mathematics', 'English', 'Physics', 'Technical Drawing']),
        csecSubjects: JSON.stringify(['Mathematics', 'English Language', 'Physics', 'Technical Drawing', 'Information Technology']),
    ...
    prisma.student.create({
      data: {
        ...
        grade: 'Form 5',
        subjects: JSON.stringify(['Mathematics', 'English', 'Chemistry', 'Biology', 'Spanish']),
        csecSubjects: JSON.stringify(['Mathematics', 'English Language', 'Chemistry', 'Biology', 'Spanish', 'Principles of Accounts']),
  ...
  const volunteers = await Promise.all([
    prisma.volunteer.create({
      data: {
        ...
        expertise: JSON.stringify(['Mathematics', 'Physics', 'Chemistry']),
    ...
    prisma.volunteer.create({
      data: {
        ...
        expertise: JSON.stringify(['Mathematics', 'Information Technology', 'Physics']),
    ...
    prisma.volunteer.create({
      data: {
        ...
        expertise: JSON.stringify(['Chemistry', 'Biology', 'English Language']),
  ...
  const sessions = await Promise.all([
    prisma.session.create({
      data: {
        ...
        endTime: '17:30',
        subject: 'Mathematics',
        topics: JSON.stringify(['Quadratic Equations', 'Factorization']),
    ...
    prisma.session.create({
      data: {
        ...
        endTime: '18:30',
        subject: 'Physics',
        topics: JSON.stringify(['Newton\'s Laws of Motion', 'Force and Acceleration']),
  ...
  const assessments = await Promise.all([
    prisma.assessment.create({
      data: {
        ...
        percentage: 90,
        grade: 'A',
        topicsAssessed: JSON.stringify(['Algebra', 'Quadratic Equations']),
    ...
    prisma.assessment.create({
      data: {
        ...
        percentage: 85,
        grade: 'B',
        topicsAssessed: JSON.stringify(['Chemical Bonding', 'Periodic Table']),
